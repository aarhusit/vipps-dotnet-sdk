...
namespace Vipps.net.Models.AccessToken
{
    ...
    public partial interface IVippsAccessToken
    {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        Task<TokenResponse> FetchTokenAsync(string authorization, Body body, CancellationToken cancellationToken = default(CancellationToken));

    }

    [GeneratedCode("NSwag", "14.0.2.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class VippsAccessToken : IVippsAccessToken
    {
    ...
    #pragma warning restore 8618 // Set by constructor via BaseUrl property
        ...
        public VippsAccessToken(System.Net.Http.HttpClient httpClient)
        {
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<AuthorizationTokenResponse> FetchAuthorizationTokenUsingPostAsync(System.Guid client_id, string client_secret, string ocp_Apim_Subscription_Key, string merchant_Serial_Number = null, string vipps_System_Name = null, string vipps_System_Version = null, string vipps_System_Plugin_Name = null, string vipps_System_Plugin_Version = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "accesstoken/get"
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<TokenResponse> FetchTokenAsync(string authorization, Body body, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (body == null)
