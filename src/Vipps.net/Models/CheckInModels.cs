...
namespace Vipps.net.Models.CheckIn
{
    using System;
    ...
    public partial interface IVippsCheckIn
    {
        ...
        /// </remarks>
        /// <param name="authorization">The access token is a base64-encoded string that is required for all API calls.
        /// <br/>It is a JWT (JSON Web Token). The access token is fetched from the
        ...
        /// <param name="merchant_Serial_Number">The merchant serial number (MSN) for the sales unit. Partners must always send
        /// <br/>the Merchant-Serial-Number header, and we recommend that everyone sends it,
        /// <br/>also when using the merchant's own API keys. The Merchant-Serial-Number header
        ...
        Task<string> InitiateLoyaltyCheckInAsync(string authorization, string ocp_Apim_Subscription_Key, LoyaltyCheckInRequest body = null, string merchant_Serial_Number = null, string vipps_System_Name = null, string vipps_System_Version = null, string vipps_System_Plugin_Name = null, string vipps_System_Plugin_Version = null, CancellationToken cancellationToken = default(CancellationToken));

    }

    [GeneratedCode("NSwag", "14.0.2.0 (NJsonSchema v11.0.0.0 (Newtonsoft.Json v13.0.0.0))")]
    public partial class VippsCheckIn : IVippsCheckIn
    {
    ...
    #pragma warning restore 8618 // Set by constructor via BaseUrl property
        ...
        public VippsCheckIn(System.Net.Http.HttpClient httpClient)
        {
            BaseUrl = "https://api.vipps.no/point-of-sale";
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async Task<string> InitiateLoyaltyCheckInAsync(string authorization, string ocp_Apim_Subscription_Key, LoyaltyCheckInRequest body = null, string merchant_Serial_Number = null, string vipps_System_Name = null, string vipps_System_Version = null, string vipps_System_Plugin_Name = null, string vipps_System_Plugin_Version = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "v1/loyalty-check-in"
                    urlBuilder_.Append("v1/loyalty-check-in");
                    ...
                    try
                    {
                        ...
                        {
                            string responseText_ = ( response_.Content == null ) ? string.Empty : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            throw new ApiException("InternalServerError. If you try to use Check-in from the Merchant Test environment, it will fail with this error.", status_, responseText_, headers_, null);
                        }
                        else
                        {
    ...
    public partial class LoyaltyCheckInRequest
    {
        /// <summary>
    ...
    public partial class ErrorResponse
    {
        ...
        public ICollection<InvalidParams> InvalidParams { get; set; }
