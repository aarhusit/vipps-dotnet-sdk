...
internal sealed class RecurringServiceClient : BaseServiceClient
{
    ...
    internal RecurringServiceClient(
    ...
    protected override async Task<Dictionary<string, string>> GetHeaders(CancellationToken cancellationToken)
    {
